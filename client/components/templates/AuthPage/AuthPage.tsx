...
import SignUpForm from "@/components/modules/AuthPage/SingUpForm";
import SignInForm from "@/components/modules/AuthPage/SingInForm";
          ...
          {!isMedia800 && (
            <>
              ...
              >
                ...
                Введіть особисті данні для регістрації на сайті
              </p>
            </>
          )}
          <button
